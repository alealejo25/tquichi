...
Route::resource('abms/transportes','TransporteController');



Route::resource('operaciones','OperacionController');
Route::get('operaciones/{id?}/movproveedor', 'OperacionController@movproveedor')->name('movproveedor');
Route::get('operaciones/{id?}/movcliente', 'OperacionController@movcliente')->name('movcliente');
Route::get('operaciones/{id?}/movflete', 'OperacionController@movflete')->name('movflete');
...
Route::get('operaciones/{id?}/detalles', 'OperacionController@detalles')->name('detalles');
...
Route::post('operaciones/guardarrendicionflete', 'OperacionController@guardarrendicionflete')->name('guardarrendicionflete');
...
Route::get('pagos/transporte/{id?}/cerrarop','PagoController@cerraroptransporte')->name('cerraroptransporte');
...
Route::get('pagos/optransportes','PagoController@optransportes'); 
Route::post('pagos/generaroptransporte','PagoController@generaroptransporte')->name('generaroptransporte');

Route::get('pagos/transporte/{id?}/pagoefectivotransporte', 'PagoController@pagoefectivotransporte')->name('pagoefectivotransporte');
...
Route::get('cuentascorrientes/transportes/','CtaCteChoController@index');
Route::get('cuentascorrientes/transportes/{id?}/nuevocomprobante', 'CtaCteChoController@nuevocomprobante')->name('nuevocomprobante');
Route::post('cuentascorrientes/transportes/guardarcomprobantet/{id?}','CtaCteChoController@guardarcomprobantet')->name('guardarcomprobantet');
Route::get('cuentascorrientes/transportes/{id?}/listar', 'CtaCteChoController@listarcomprobantes')->name('listarcomprobantes');
