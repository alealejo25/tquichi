  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="almacen/camiones"><i class="fa fa-circle-o"></i> Camiones</a></li>
                <li><a href="categoria"><i class="fa fa-circle-o"></i> Choferes</a></li>
                <li><a href="categoria"><i class="fa fa-circle-o"></i> Choferes</a></li>
                <li><a href="almacen/categoria"><i class="fa fa-circle-o"></i> Cuentas</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="compras/ingreso"><i class="fa fa-circle-o"></i> Iniciar Operacion</a></li>
                <li><a href="compras/proveedor"><i class="fa fa-circle-o"></i> Operaciones</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="configuracion/usuario"><i class="fa fa-circle-o"></i> Caja Inicial</a></li>
                <li><a href="configuracion/usuario"><i class="fa fa-circle-o"></i> Cheques</a></li>
                <li><a href="configuracion/usuario"><i class="fa fa-circle-o"></i> Cierres de Caja</a></li>
                <li><a href="configuracion/usuario"><i class="fa fa-circle-o"></i> Gastos Varios</a></li>
                <li><a href="configuracion/usuario"><i class="fa fa-circle-o"></i> Transferencias de Cajas</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="configuracion/usuario"><i class="fa fa-circle-o"></i> Cheques</a></li>
                <li><a href="configuracion/usuario"><i class="fa fa-circle-o"></i> Efectivo</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Integral QUICHI</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="#">DELFA Informatica.</a>.</strong>  All rights reserved.
      </footer>
