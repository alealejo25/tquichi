...
@endif
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<h3>Listado de Comprobantes - Transporte: @foreach ($transporte as $transportes){{$transportes->nombre}} 				@endforeach
	</h3>
				</div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($cuentacorrientetransporte as $cliente)
				<tr>
					<td>{{ $cliente->id}}</td>
					...
					<td>
				 	<form method="get" class="submit-prevent-form" action="{{url('cuentascorrientes/transportes/'.$cliente->id.'/anular') }}">
		...
		{{$cuentacorrientetransporte->render()}}
	</div>
</div>
