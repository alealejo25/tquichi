...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			...
			{!!Form::open(['route' => ['guardarfinalizarflete',$id],'method'=>'POST','class'=>'submit-prevent-form'])!!}
	...
	<br>
			...
			<div class="row">
				<div class="Form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('valorflete','<div class="invalid-feedback text-danger">:message</div>')!!}
				</div>
			</div>
			...
			<div class="form-group col-lg-3 col-md-4 col-sm-12">
				...
				{!! $errors->first('kmfin','<div class="invalid-feedback text-danger">:message</div>')!!}
			</div>
			<div class="form-group col-lg-3 col-md-4 col-sm-12">
				...
				{!! $errors->first('importe','<div class="invalid-feedback text-danger">:message</div>')!!}
			...
			<div class="form-group col-lg-6 col-md-4 col-sm-12">
				...
				{!! $errors->first('descripcion','<div class="invalid-feedback text-danger">:message</div>')!!}
			</div>
			...
			<div class="row">
 				<div class="form-group col-lg-6 col-md-4 col-sm-12">
					...
					{!! $errors->first('cliente_id1','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				<div class="form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('remito1','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				<div class="form-group col-lg-2 col-md-4 col-sm-12">
					...
					{!! $errors->first('pallete1','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				...
 				<div class="form-group col-lg-6 col-md-4 col-sm-12">
					...
					{!! $errors->first('clientedev1','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				<div class="form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('valepalletd1','<div class="invalid-feedback text-danger">:message</div>')!!}
					...
					{!! $errors->first('palletd1','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 			...
 			<div class="row">
 				<div class="form-group col-lg-6 col-md-4 col-sm-12">
					...
					{!! $errors->first('cliente_id2','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				<div class="form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('remito2','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				<div class="form-group col-lg-2 col-md-4 col-sm-12">
					...
					{!! $errors->first('pallete2','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
				<div class="form-group col-lg-6 col-md-4 col-sm-12">
 					<label for="clientedev2">Seleccione Cliente 2- Devuelve pallet</label>
					<select name="clientedev2" id="clientedev2" class="form-control">
					<option value="">Selecccione un cliente</option>
						@foreach ($clientesnombres as $cliente) 
					<option value="{{ $cliente->nombre }}">{{$cliente->nombre}}</option>
						@endforeach
 				 ...
 				 <div class="form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('valepalletd2','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				 <div class="form-group col-lg-2 col-md-4 col-sm-12">
					...
					{!! $errors->first('palletd2','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 			...
 			<hr size="8px">
 			 ...
 			 <div class="row">
 				...
 				<div class="form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('remito3','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				<div class="form-group col-lg-2 col-md-4 col-sm-12">
 				...
 				<div class="form-group col-lg-6 col-md-4 col-sm-12">
 					<label for="clientedev3">Seleccione Cliente 3- Devuelve pallet</label>
 				...
 				<div class="form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('valepalletd3','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				 <div class="form-group col-lg-2 col-md-4 col-sm-12">
					...
					{!! $errors->first('palletd3','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 			...
 			<hr size="8px">
 			 ...
 			 <div class="row">
 				...
 				<div class="form-group col-lg-4 col-md-4 col-sm-12">
					<label for="remito4">Nro. Remito vuelta 4</label>
					<input type="text" name="remito4" class="form-control {{$errors->has('remito4')?'is-invalid':''}}" value="{{old('remito4')}}"> 
					{!! $errors->first('remito4','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				<div class="form-group col-lg-2 col-md-4 col-sm-12">
 				...
 				<div class="form-group col-lg-6 col-md-4 col-sm-12">
 					<label for="clientedev4">Seleccione Cliente 4- Devuelve pallet</label>
 				...
 				<div class="form-group col-lg-4 col-md-4 col-sm-12">
					...
					{!! $errors->first('valepalletd4','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
 				 ...
 				 <div class="form-group col-lg-2 col-md-4 col-sm-12">
					...
					{!! $errors->first('palletd4','<div class="invalid-feedback text-danger">:message</div>')!!}
 				</div>
				...
				<table>
					<tr>
						...
						<td>
							...
							{!! $errors->first('vale1','<div class="invalid-feedback text-danger">:message</div>')!!}
						</td>
						<td>&nbsp;</td>
						<td>
							...
							{!! $errors->first('nroremitoestacion1','<div class="invalid-feedback text-danger">:message</div>')!!}
						</td>
					</tr>
				</table>
			</div>
				...
				<table>
					<tr>
						...
						<td>
							...
							{!! $errors->first('vale2','<div class="invalid-feedback text-danger">:message</div>')!!}
						</td>
						<td>&nbsp;</td>
						<td>
							...
							{!! $errors->first('nroremitoestacion2','<div class="invalid-feedback text-danger">:message</div>')!!}
						</td>
					</tr>
				</table>
			</div>
				...
				<table>
					<tr>
						...
						<td>
							...
							{!! $errors->first('vale3','<div class="invalid-feedback text-danger">:message</div>')!!}
						</td>
						<td>&nbsp;</td>
						<td>
							...
							{!! $errors->first('nroremitoestacion3','<div class="invalid-feedback text-danger">:message</div>')!!}
						</td>
					</tr>
				</table>
			</div>
